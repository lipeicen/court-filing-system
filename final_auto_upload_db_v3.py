...
def create_preservation(page):
    ...
    # 截图确认页面状态
    try:
        page1.screenshot(path=r'/opt/court-auto-filing/debug_after_create.png')
...
def add_applicant(page1):
    ...
    # 截图确认弹窗状态
    page1.screenshot(path=r'/opt/court-auto-filing/debug_applicant_popup.png')
...
def add_respondent(page1):
    ...
    if respondent_type == '自然人':
        ...
        # 截图确认填写状态
        page1.screenshot(path=r'/opt/court-auto-filing/debug_respondent_before_save.png')
...
def add_guarantee(page1):
    ...
    try:
        ...
        if table_data == 0:
            ...
            # 截图查看状态
            page1.screenshot(path=r'/opt/court-auto-filing/debug_guarantee_empty.png')
    except:
        pass
    ...
    # 截图确认页面状态
    try:
        page1.screenshot(path=r'/opt/court-auto-filing/debug_after_guarantee.png')
    except:
        print("  截图失败")
...
def upload_files(page1):
    ...
    # 先截图确认当前页面
    page1.screenshot(path=r'/opt/court-auto-filing/debug_before_next.png')
    ...
    # 截图确认是否进入材料上传页面
    page1.screenshot(path=r'/opt/court-auto-filing/debug_after_next.png')
    ...
    # 截图确认页面状态
    page1.screenshot(path=r'/opt/court-auto-filing/debug_material_page.png')
