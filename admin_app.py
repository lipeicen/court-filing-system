...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(r'/opt/court-auto-filing/admin_app.log', encoding='utf-8'),
...
UPLOAD_BASE = r'/opt/court-auto-filing/uploads'
...
def auto_filing_start():
    ...
    def run_filing():
        ...
        try:
            ...
            try:
                import json
                with open(r'/opt/court-auto-filing//auto_filing_progress.json', 'r', encoding='utf-8') as f:
                    progress = json.load(f)
                progress['running'] = False
                progress['current_case'] = None
                with open(r'/opt/court-auto-filing//auto_filing_progress.json', 'w', encoding='utf-8') as f:
...
def auto_filing_selected():
    ...
    with open(r'/opt/court-auto-filing/auto_filing_debug.txt', 'w', encoding='utf-8') as f:
        f.write(debug_info)
    if not case_nos:
...
def auto_filing_stop():
    """停止自动立案"""
    import os
    stop_file = r'/opt/court-auto-filing//auto_filing_stop.flag'
